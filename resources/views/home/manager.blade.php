        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="products.html"><i class="fa fa-fw fa-bar-chart-o"></i> Contact</a>
                    </li>
                    <li>
                        <a href="add_product.html"><i class="fa fa-fw fa-table"></i>inbox</a>
                    </li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Welcome to manager
                            </li>
                        </ol>
                    </div>
                </div>
